...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Munch Machine Vending Ltd — Premium Vending & Entertainment" },
      { property: "og:description", content: "Premium vending machines and interactive entertainment equipment installed across London and Essex." },
