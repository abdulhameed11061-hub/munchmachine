...
function Page() {
  const categories = [
    { icon: Cookie, name: "Snack Vending",        img: smallImg,  desc: "Crisps, chocolate, healthy bars and grab-and-go essentials, curated to your audience.", features: ["Adjustable spirals", "Drop sensors", "Healthy options available"] },
    { icon: CupSoda, name: "Drink Vending",       img: mediumImg, desc: "Chilled cans, bottles, isotonics and waters. Refilled on a schedule that matches demand.", features: ["Triple-zone cooling", "Brand favourites", "Bottle & can compatible"] },
    { icon: Layers, name: "Combination Machines", img: largeImg,  desc: "Snacks and drinks in one beautifully presented unit — the most popular choice.", features: ["Single glass-front", "Dual temp zones", "High-capacity"] },
  ...
  const sizes = [
    { title: "Small",  capacity: "Up to ~30 lines", ideal: "Salons, studios, small offices",       footprint: "W 700mm · D 800mm · H 1830mm",  img: smallImg },
    { title: "Medium", capacity: "Up to ~40 lines", ideal: "Hotels, gyms, mid-size offices",       footprint: "W 900mm · D 850mm · H 1900mm",  img: mediumImg, featured: true },
    { title: "Large",  capacity: "60+ lines",       ideal: "Warehouses, large sites, hospitals",   footprint: "W 1050mm · D 900mm · H 1950mm", img: largeImg },
  ];
